...
const translations = {
    uz: {
        ...
        about_desc: "Cyber Brother - bu shunchaki antivirus emas. Bu sizning raqamli dunyodagi shaxsiy qo'riqchingiz. Bizning asosiy maqsadimiz - foydalanuvchi ma'lumotlarini 100% maxfiy saqlagan holda, eng zamonaviy tahdidlardan himoya qilishdir.",
        stat_1_val: "100%",
        ...
        feat_lang_title: "Ko'p Tilli AI",
        feat_lang_desc: "O'zbek, Rus va Ingliz tillarida firibgarlikni taniy oladigan yagona aqlli tizim.",
        feat_bat_title: "Aqlli Quvvat Tejash",
        feat_bat_desc: "AI tahlillari faqat telefon quvvat olayotganda yoki ishlatilmayotganda bajariladi. 0% quvvat sarfi.",
        feat_5_title: "Maxfiy Ombor",
        feat_5_desc: "Shaxsiy fayl va rasmlaringizni maxfiy shifrlangan omborda saqlaydi.",
        feat_lic_title: "Oflayn Litsenziya",
        feat_lic_desc: "Internet bo'lmasa ham, ilova litsenziyasini Hardware ID orqali faollashtiring.",
        ...
        footer_rights: "© 2026 Cyber Brother. Barcha huquqlar himoyalangan.",
    ...
    ru: {
        ...
        about_desc: "Cyber Brother - это не просто антивирус. Это ваш личный охранник в цифровом мире. Наша главная цель - защита от самых современных угроз при полной конфиденциальности данных.",
        stat_1_val: "100%",
        ...
        feat_lang_title: "Мультиязычный AI",
        feat_lang_desc: "Единственная система, распознающая мошенничество на узбекском, русском и английском языках.",
        feat_bat_title: "Умное энергосбережение",
        feat_bat_desc: "AI анализ работает только при зарядке или в режиме ожидания. 0% расхода батареи.",
        feat_5_title: "Секретное хранилище",
        feat_5_desc: "Храните личные файлы и фотографии в зашифрованном хранилище.",
        feat_lic_title: "Офлайн лицензия",
        feat_lic_desc: "Активируйте лицензию через Hardware ID, даже без интернета.",
        ...
        footer_rights: "© 2026 Cyber Brother. Все права защищены.",
    ...
    en: {
        ...
        about_desc: "Cyber Brother is not just an antivirus. It is your personal guardian in the digital world. Our main goal is to protect against modern threats while keeping your data 100% private.",
        stat_1_val: "100%",
        ...
        feat_lang_title: "Multi-language AI",
        feat_lang_desc: "The only smart system that detects fraud in Uzbek, Russian, and English.",
        feat_bat_title: "Smart Power Saving",
        feat_bat_desc: "AI analysis runs only when charging or idle. 0% battery drain.",
        feat_5_title: "Privacy Vault",
        feat_5_desc: "Store your personal files and photos in an encrypted vault.",
        feat_lic_title: "Offline License",
        feat_lic_desc: "Activate your license via Hardware ID, even without internet.",
        ...
        footer_rights: "© 2026 Cyber Brother. All rights reserved.",
